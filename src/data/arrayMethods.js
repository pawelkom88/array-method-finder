const arrayMethods = [
  ...
  },
  {
    ...
    usage: {
      example1: 'let arr = [1, 2, 3];',
      example2: 'function printElements(el){ console.log(el) };',
      example3: 'arr.forEach(printElements);',
    },
    output: '1, 2, 3',
    type: 'forEach',
  ...
  },
  {
    ...
    usage: {
      example1: 'let arr = [1, 2, 3];',
      example2: 'function addOne(el){ return el + 1 };',
      example3: 'arr.map(addOne);',
    },
    output: '[2, 3, 4]',
    type: 'map',
  ...
  },
  {
    ...
    name: 'Array.entries()',
    usage: {
      example1: 'let arr = ["a", "b", "c"];',
      example2: 'iterator = array.entries();',
      example3: 'iterator.next().value',
    },
    output: '[0, "a"]',
    type: 'entries',
    desc: 'Returns a new Array Iterator object that contains the key/value pairs for each index in the array. There are a lot of uses for iterators, as well as other methods used with it in conjuction, like values and keys.',
    doc: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/entries',
  },
  {
    id: 22,
    name: 'Array.join()',
    ...
    output: '"1, 2, 3"',
    type: 'join',
    desc: 'Joins all elements of an array into a string. You can join it together as is or with something in between, elements.join(-) gives you java-script.',
    doc: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/join',
  },
  {
    id: 23,
    name: 'Array.toString()',
    usage: {
      example1: 'let arr = [1, 2, 3];',
      example3: 'arr.toString()',
    },
    output: '"1, 2, 3"',
    type: 'toString',
    desc: 'Returns a string representing the array and its elements.',
    doc: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/toString',
  },
  {
    id: 24,
    name: 'Array.toLocaleString()',
    usage: {
      example1: 'let arr = ["It is Christmas !", new Date("24 Dec 2021 17:00:00 UTC")];',
      example3: 'let localeString = arr.toLocaleString("en", { timeZone: "UTC" });',
    },
    output: 'It is Christmas !,24 Dec 2021 17:00:00 UTC',
    type: 'toLocaleString',
    ...
    doc: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/toLocaleString',
  },
  {
    id: 25,
    name: 'Array.reverse()',
    usage: {
      example1: 'let arr = [1, 2, 3];',
      example3: 'arr.reverse();',
    },
    output: '[3, 2, 1]',
    type: 'reverse',
    desc: 'Reverses the order of the elements of an array in place — the first becomes the last, and the last becomes the first.',
    doc: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse',
  },
  {
    id: 26,
    name: 'Array.sort()',
    usage: {
      example1: 'let arr = [2, 1, 3];',
      example3: 'arr.sort();',
    },
    output: '[1, 2, 3]',
    type: 'sort',
